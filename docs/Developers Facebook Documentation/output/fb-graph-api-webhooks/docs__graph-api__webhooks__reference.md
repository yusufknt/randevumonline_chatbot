...
_Source: https://developers.facebook.com/docs/graph-api/webhooks/reference_
...
| [`Page`](https://developers.facebook.com/docs/graph-api/webhooks/reference/page/) | Page profile webhook fields you can subscribe to. In order for these webhooks to be sent to an app's webhook callback URL, a page admin with MODERATE privileges must grant the app the pages\_manage\_metadata permission. |
