# Mentioned Media - Instagram Platform

_Source: https://developers.facebook.com/docs/instagram-platform/instagram-graph-api/reference/ig-user/mentioned_media_
...
| `{fields}`  *Comma-separated list* | A comma-separated list of IG Media [Fields](#fields) you want returned. If omitted, default Fields will be returned. |
...
| `comments_count`  *String* | Number of IG Comments on the IG Media. |
...
| `media_type`  *String* | The IG Media's type: `CAROUSEL_ALBUM`, `IMAGE`, `STORY`, or `VIDEO`. |
| `media_url`  *String* | URL of the published IG Media. |
