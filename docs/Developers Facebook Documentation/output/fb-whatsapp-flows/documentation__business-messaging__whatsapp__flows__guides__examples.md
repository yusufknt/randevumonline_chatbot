# Examples | Developer Documentation

_Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/flows/guides/examples_
...
Book Appointments with WhatsApp Flows: Creating a Node.js Back End
...
Create Surveys with WhatsApp Flows
...
Add WhatsApp Flows to Your Chatbot Experience
...
Webhook Example to Send Flows

This is an example webhook server to send a Flow message and receive its response.

3.

Endpoint encryption/decryption examples in various languages
