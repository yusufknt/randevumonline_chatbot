...
_Source: https://developers.facebook.com/docs/messenger-platform/send-api-reference/url-button_
...
| --- | --- | --- |
| [URL button](https://developers.facebook.com/docs/messenger-platform/send-api-reference/buttons/url) | `web_url` | Opens a web page in the Messenger webview |
| [Postback button](https://developers.facebook.com/docs/messenger-platform/send-api-reference/buttons/postback) | `postback` | Sends a postback event to your webhook |
| [Call button](https://developers.facebook.com/docs/messenger-platform/send-api-reference/buttons/call) | `phone_number` | Dials a phone number |
| [Log in button](https://developers.facebook.com/docs/messenger-platform/send-api-reference/buttons/login) | `account_link` | Triggers the account linking authentication flow |
| [Log out button](https://developers.facebook.com/docs/messenger-platform/send-api-reference/buttons/logout) | `account_unlink` | Unlinks a linked account |
| [Game play button](https://developers.facebook.com/docs/messenger-platform/send-api-reference/buttons/game-play) | `game_play` | Launches an Instant Game |
