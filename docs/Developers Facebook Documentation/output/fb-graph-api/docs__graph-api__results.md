...
_Source: https://developers.facebook.com/docs/graph-api/results_
...
- `until` : A Unix timestamp or [`strtotime`](https://l.facebook.com/l.php?u=http%3A%2F%2Fphp.net%2Fmanual%2Fen%2Ffunction.strtotime.php&h=AUB1fi7J10fH8yr2ZWL_rVKP4xTf7jyuYBVqJV4Fj3ChYigJ_IkIHsgkjvl7msdU4NfICZK7kuzlsz6kYESTqHxqK-_DH0Qe03E1HyLLGSJNTjPPaRqF1Qevm37Ch8ToGEwjsNGgfrKsHA) data value that points to the end of the range of time-based data.
- `since` : A Unix timestamp or [`strtotime`](https://l.facebook.com/l.php?u=http%3A%2F%2Fphp.net%2Fmanual%2Fen%2Ffunction.strtotime.php&h=AUAMaf7areSF7VdDwQyxZJi9zXWrhAEOyhKzzbgKEl_jhTM7tcWq30kZuU2dU13Z73qqPg2RLntLVNGG9K1-EdOA-bRVIpn7XY40yLq25514J32QzFTdRzyVswK8ILHAX3r7Ee9MpO6XeyhMZVLysxwzqCA) data value that points to the start of the range of time-based data.
