# Image messages webhook reference | Developer Documentation

_Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/messages/image_
...
| `<MEDIA_ASSET_CAPTION>`<br>*String* | Media asset caption text. | `Taj Mahal` |
...
| `<MEDIA_ASSET_MIME_TYPE>`<br>*String* | Media asset MIME type. | `image/jpeg` |
