...
_Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/messages/button_
...
| `<BUTTON_LABEL_TEXT>`<br>*String* | Quick-reply button label text. | `Unsubscribe` |
