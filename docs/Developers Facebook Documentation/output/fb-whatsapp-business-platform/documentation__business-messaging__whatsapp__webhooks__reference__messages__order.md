...
_Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/messages/order_
...
| `<CURRENCY_CODE>`<br>*String* | Catalog currency code. | `USD` |
...
| `<ORDER_TEXT>`<br>*String* | Text accompanying the order. | `Love these!` |
...
| `<PRODUCT_PRICE>`<br>*Integer* | Individual product price. | `7.99` |
| `<PRODUCT_QUANTITY>`<br>*Integer* | Product quantity. | `2` |
