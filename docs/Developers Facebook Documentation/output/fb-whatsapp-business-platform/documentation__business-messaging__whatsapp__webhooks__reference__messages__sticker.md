# Sticker messages webhook reference | Developer Documentation

_Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/messages/sticker_
...
| `<IS_ANIMATED?>`<br>*Boolean* | Boolean indicating if the sticker is animated (`true`) or not (`false`). | `true` |
...
| `<MEDIA_ASSET_MIME_TYPE>`<br>*String* | Media asset MIME type. | `image/webp` |
