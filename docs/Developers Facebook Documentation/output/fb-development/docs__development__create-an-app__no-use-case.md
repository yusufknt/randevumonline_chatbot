# No Use Case - App Development with Meta

_Source: https://developers.facebook.com/docs/development/create-an-app/no-use-case_
...
If you're a Tech Provider, you're building an app that will be serving clients or other business portfolios, you're required to connect your app to a business that has completed both Access and Business Verification before you can [publish your app](#publish-your-app).

However, you can connect a business now or at any time during the development process.

1. Select an option and click **Next**.

[Learn more](https://developers.facebook.com/docs/development/release/access-verification) about Access and Business Verification.
...
- [Annual Data Use Checkup](https://developers.facebook.com/docs/resp-plat-initiatives/individual-processes/data-use-checkup/)
- [App Review requirements](https://developers.facebook.com/docs/resp-plat-initiatives/individual-processes/app-review/)

You can also review the [Meta Platform Terms](https://developers.facebook.com/terms/) and [Developer Policies](https://developers.facebook.com/devpolicy/).
