# Business Asset User Profile Access - App Development with Meta

_Source: https://developers.facebook.com/docs/features-reference/business-asset-user-profile-access_
