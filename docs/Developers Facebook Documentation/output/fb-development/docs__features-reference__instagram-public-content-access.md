# Instagram Public Content Access - App Development with Meta

_Source: https://developers.facebook.com/docs/features-reference/instagram-public-content-access_
