# Use Case Customization - App Development with Meta

_Source: https://developers.facebook.com/docs/development/app-customization_

---

# Use Case Customization

Select a use case from the left-side menu to learn how to customize that use case.

## Available use cases

The following table shows you the available use cases you can add to your app.
