# Trust Center - App Development with Meta

_Source: https://developers.facebook.com/docs/development/trust-center_
...
- **[For advanced permissions, complete the Data Protection Assessment](https://developers.facebook.com/blog/post/2021/07/22/introducing-data-protection-assessment)**
...
- **[Describing data protection and security practices for Advanced Permissions (Data Protection Assessment)](https://developers.facebook.com/blog/post/2021/07/22/introducing-data-protection-assessment)**
...
We have a process to verify the identity of a business that owns apps that interact with our APIs.This is different from the verification badge for notable accounts on our Family of Apps.
Advanced permissions that you request will require business verification. For more information, visit the [Business Verification documentation.](https://developers.facebook.com/docs/development/release/business-verification)
