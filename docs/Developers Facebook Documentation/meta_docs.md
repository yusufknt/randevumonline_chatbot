...
Kaynak: https://developers.facebook.com/docs/
...
- [Learn the basics of how to send and receive data from the Meta social graph](https://developers.facebook.com/docs/graph-api/overview)
...
- [Docs](https://developers.facebook.com/docs/resp-plat-initiatives)
### App Integrations
...
- [Limited Facebook Login](https://developers.facebook.com/documentation/facebook-login/ios/limited-login)
...
- [Instant Games](https://developers.facebook.com/documentation/games)
### Social Integrations
